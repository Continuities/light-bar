(function() {
  ...
  /** Constants **/
  var WIDTH = 32
  ,   HEIGHT = 8 // BEST IF ODD
  ;

  var PATTERNS = {
    bsod: [
        [0, 1], [0, 2], [0, 6], [0, 7], [0, 11], [0, 12], [0, 15], [0, 16],
        [1, 0], [1, 2], [1, 5], [1, 10], [1, 12], [1, 15], [1, 17],
        [2, 0], [2, 1], [2, 2], [2, 5], [2, 6], [2, 7], [2, 10], [2, 12], [2, 15], [2, 17],
        [3, 0], [3, 2], [3, 7], [3, 10], [3, 12], [3, 15], [3, 17],
        [4, 0], [4, 2], [4, 7], [4, 10], [4, 12], [4, 15], [4, 17],
        [5, 0], [5, 1], [5, 5], [5, 6], [5, 10], [5, 11], [5, 15], [5, 16]
    ]
  };
  ...
  StandingWave.prototype = {
    ...
    go: function(model, delta) {
      ...
      this.lights.forEach(function(light) {
        ...
        light.row = cap(Math.round(current), 0, HEIGHT - 1);
      });
    }
  };
